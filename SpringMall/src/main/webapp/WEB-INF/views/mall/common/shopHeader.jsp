...
<header>
	...
	<div class="t_box1"> <%-- 구역1 (상단좌측): 로그인, 회원가입, 고객센터 --%>
		...
		<c:if test="${member != null }">
			<a href="memberInfo.do?id=${member.id }">${member.name }님</a>&ensp;|&ensp;<a href="memberLogout.do">로그아웃</a>&ensp;|&ensp;
		</c:if>
	...
	<div class="t_box2"> <%-- 구역2 (상단우측): 회원정보, 구매정보, 장바구니정보 --%>
		...
		<c:if test="${member == null }">
			<a href="memberLogin.do?id=${member.id }"><img src="resources/img/user-white.png" width="35" title="회원정보" class="t_box2_img1"></a>
