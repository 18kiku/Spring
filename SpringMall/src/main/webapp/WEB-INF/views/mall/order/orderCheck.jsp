...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/mall/order/orderCheck.css">
	...
	$(".btn_order").on("click", function () { /* 주소 정보 & 받는이*/
	    $(".div_addressInfo_input").each(function (i, obj) {
	        if ($(obj).find(".selectAddress").val() === 'T') {
	            $("input[name='addressee']").val($(obj).find(".input_addressee").val());
			...
			<div class="content_main">
				...
				<div class="div_addressInfo">
					<div class="div_addressInfo_button">
						<button class="btn_address btn_address_1" onclick="showAdress('1')" style="background-color: #3c3838;">상용자 정보 주소록</button>
						<button class="btn_address btn_address_2" onclick="showAdress('2')">직접 입력</button>
					</div>
						...
						<div class="div_addressInfo_input div_addressInfo_input_1" style="display: block">
							...
							<tr>
								...
								<td>
									...
									<input class="input_addressee" value="${member.name}" type="hidden">
